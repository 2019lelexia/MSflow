...
class Spring(FlowDataset):
    ...
    """
    def __init__(self, aug_params=None, root='/home/ubuntu/dataset/zml/Spring', split='train', scene_idx=None, scene_idx_out=None, subsample_groundtruth=True):
        ...
        for scene in sorted(os.listdir(seq_root)):
            if scene_idx is not None and scene != scene_idx:
                continue
            if scene_idx_out is not None and scene in scene_idx_out:
                continue
