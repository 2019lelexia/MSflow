...
class ViTWarpV8(nn.Module):
    def __init__(self, args):
        ...
        self.agg = FastGMA(dim=self.network_dim, heads=1, dim_head=self.network_dim)
        ...
        self.cmap_conv = nn.Conv2d(64, self.network_dim, kernel_size=1, stride=1, padding=0, bias=True)
    ...
    def forward(self, image1, image2, iters=None, flow_gt=None):
        ...
        cmap1_2x = self.cmap_conv(fmap1_feats[0])
