...
class ViTWarpV8(nn.Module):
    ...
    def forward(self, image1, image2, iters=None, flow_gt=None):
        ...
        for itr in range(iters):
            ...
            refine_outs_4x = F.interpolate(refine_outs, scale_factor=0.5, mode='bilinear', align_corners=True)
            refine_outs_8x = F.interpolate(refine_outs, scale_factor=0.25, mode='bilinear', align_corners=True)
            ...
            net_4x = self.fusion1(net_4x, net_8x)
            net = self.fusion2(net, net_4x)
