            ...
            if total_steps % args.val_freq == args.val_freq - 1 and rank == 0:
                ...
                for val_dataset in args.validation:
                    if val_dataset == 'sintel_train':
                        ...
                        results.update(validate.validate_spring(model, args, rank))
                    else:
                        print(val_dataset)
                ...
                PATH1 = os.path.join(args.log_dir, PATH)
                os.makedirs(os.path.dirname(PATH1), exist_ok=True)
                torch.save(model.module.state_dict(), PATH1)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--validation', default=['sintel_train', 'spring_train'], type=str, nargs='+')
